                ...
                <table className="w-full text-sm min-w-[800px]">
                  <thead>
                    <tr className="border-b border-[#ccbeac]/30">
                      ...
                      <th className="text-left py-2 px-2">Software</th>
                      <th className="text-left py-2 px-2 min-w-[200px]">Notes</th>
                    </tr>
                  </thead>
                  <tbody>
                    {client.products.map((p, index) => (
                      <tr key={index} className="border-b border-[#ccbeac]/10 hover:bg-gray-50 dark:hover:bg-gray-800">
                        ...
                        <td className="py-2 px-2">{p.fabriquant || '-'}</td>
                        <td className="py-2 px-2">{p.modele || '-'}</td>
                        <td className="py-2 px-2">{p.reference || '-'}</td>
                        <td className="py-2 px-2">{p.plageMesure || '-'}</td>
                        <td className="py-2 px-2">{p.annee || '-'}</td>
                        <td className="py-2 px-2">{p.versionLogiciel || '-'}</td>
